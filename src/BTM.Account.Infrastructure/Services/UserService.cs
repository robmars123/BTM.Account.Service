  ...
  public class UserService : IUserService
  {
    ...
    public async Task<Result<UserDTO>> GetUserAsync(string? userId, string? accessToken)
    {
      ...
      try
      {
        ...
        {
          var errorResponse = await DeserializeResultUserDTOAsync(response);
    ...
    private static async Task<Result<UserDTO>?> DeserializeResultUserDTOAsync(HttpResponseMessage response)
    {
