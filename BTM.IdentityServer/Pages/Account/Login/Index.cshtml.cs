...
using BTM.IdentityServer.Pages.Login;
using BTM.IdentityServer.Pages;
...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            BTM.IdentityServer.Pages.Telemetry.Metrics.UserLoginFailure(context?.Client.ClientId, IdentityServerConstants.LocalIdentityProvider, error);
